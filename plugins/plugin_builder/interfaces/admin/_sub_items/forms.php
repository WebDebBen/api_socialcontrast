<div class="row">
    ...
    <div class="col-md-9">
        <button type="button" class="btn btn-default" id="new_table">New Form</button>
        <button type="button" class="btn btn-primary" id="load_table">Load Table</button>
        <button type="button" class="btn btn-primary" id="load_form">Load Form</button>
        <button type="button" class="btn btn-info" id="preview_form">Preview Form</button>
        <button type="button" class="btn btn-success" id="save_form">Save Form</button>
    </div>
</div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="form_zone">
                            <form id="target" class="form-horizontal">
                                ...
                                <div id="legend" class="component" rel="popover" title="Form Title" trigger="manual" data-html="true"></div>
                                </fieldset>
                            </form>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" type="button" class="btn btn-primary" id="select_list">Select</button>
