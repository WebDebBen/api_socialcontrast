                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                            <div class="col-3">
                            	...
                            	<div class="input-group"><input type="button" value="-" class="button-minus" onclick="decrease_qty(this)" data-field="quantity"><input type="number" step="1" max="" value="1" name="quantity" id="quantity" class="quantity-field quantity" required><input type="button" value="+" class="button-plus" onclick="increase_qty(this)" data-field="quantity"></div>
                            </div>
                            <div class="col-5">
...
<script>
	...
	function return_product_results(pageid){
		$.ajax({
			url: "../../plugins/gevorest_stocktaking/interfaces/ajax/retrieve_products.php?pageid=" + pageid,
			type: "POST",
...
// 				$('#search_results_products').html(result);
				...
				$('#search_results_products').html(obj.message);
