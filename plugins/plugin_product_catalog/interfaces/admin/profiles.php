...
<div class="row mt-1r mb-1r"><div class="col-md-12"><button class="btn btn-success" id="profiles_new">New</button></div></div>
<div class="row mt-2r">
<div class="col-md-12">
...
<div class="col-sm-8">
<input type="text" class="form-control" data-type="string" id="profiles_field_photo">
</div>
</div>
</div>
</form>
