...
<link rel="stylesheet" type="text/css" href="//cdn.datatables.net/1.11.4/css/jquery.dataTables.min.css"><script type="text/javascript" charset="utf-8" src="assets/js/post_comment.js"></script>
<div class='main-body'>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group row">
					<label for="field-default-value" class="col-sm-2 col-form-label text-right">Post Id1</label>
					<div class="col-sm-10">
					<select class='form-control' data-reffield='id' data-reftable='posts' data-table='post_comment' data-type='relation' id='post_comment_field_post_id1'>
					</select>				</div>
			</div>
				<div class="form-group row">
					<label for="field-default-value" class="col-sm-2 col-form-label text-right">Photo2</label>
					<div class="col-sm-10">
					<div id="post_comment_field_photo2_upload" data-type="file">Select File</div>					<button class="btn btn-primary" type="button" id="post_comment_field_photo2_btn">Upload</button>				</div>
			</div>
				<div class="form-group row">
