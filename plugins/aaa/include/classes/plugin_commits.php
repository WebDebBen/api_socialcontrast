...
function save_commit_item($plugin_name, $commit_name, $commit_short_desc, $commit_desc){
    $db = $GLOBALS["db"];
    $query = "insert into commits(plugin_name, name, short_description, description) values('{$plugin_name}', '{$commit_name}', '{$commit_short_desc}', '{$commit_desc}')";
