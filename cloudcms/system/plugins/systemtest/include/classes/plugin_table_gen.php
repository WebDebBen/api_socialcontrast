<?php
    ...
    function generate_content_javascript($data, $flag = true ){
        ...
        $js = 'base_url = "/plugins/' . $plugin_name . '/interfaces/php/' . $table_name . '.php";';
        $js .= $endln . 'upload_url = "/plugins/' . $plugin_name . '/include/classes/upload.php";';
        $js .= $endln . 'export_url = "/plugins/' . $plugin_name . '/include/classes/export_excel.php";';
        $js .= $endln . 'var table;';
        $js .= $endln . 'var sel_tr;';
