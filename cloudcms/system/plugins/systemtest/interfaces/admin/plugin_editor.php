            ...
            <form action="" method="post">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs" id="editor-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="admin-interface-tab" data-toggle="pill" href="#admin-interface" rol="tab" 
                                        aria-controls="admin-interface" aria-selected="true">Interfaces</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="data-tablequery-tab" data-toggle="pill" href="#data-tablequery-interface" rol="tab" 
                                        aria-controls="data-tablequery-interface" aria-selected="true">Report Builder</a>
                        </li>
                    ...
                    <div class="tab-content px-1r" id="editor-tabContent">
                        ...
                        <div class="tab-pane fade hide" id="database-script-interface" role="tabpanel" aria-labelledby="database-script-tab">
                            <div class="card-body p-0">
